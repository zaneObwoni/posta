...
@section('content')
    ...
    <div class="container">
        ...
        <br>
        <b style="font-size:24px;">Register your Physical Box for Virtual Post Services</b>
                        ...
                        <section class="panel">
                            ...
                            <div class="panel-body">
                                <div class="position-center">
                                    ...
                                    {!! Form::open(['url' => route('physical.register-post'), 'class' => 'form-horizontal', 'enctype' => 'multipart/form-data', 'files' => true] ) !!}
                                    {!! csrf_field() !!}
