...
<div class="form-group">
    {!! Form::label('distance', 'Other Options:', array('class'=>'col-sm-3 control-label')) !!}
    <div class="col-sm-6">
...
<br>
<div class="form-group">
    {!! Form::label('weight', 'Enter Exactly weight (Kg):', array('class'=>'col-sm-3 control-label')) !!}
    <div class="col-sm-6">
...
<br>
<div class="form-group">
    {!! Form::label('building_name', 'Delivery Building/Floor:', array('class'=>'col-sm-3 control-label')) !!}
    <div class="col-sm-6">
        {!! Form::text('building_name', null, array('class'=>'form-control', 'placeholder'=>'ie. Bishop Magua Building')) !!}
    </div>
</div>
<br>
<br>
<div class="form-group">
    {!! Form::label('street', 'Delivery Street:', array('class'=>'col-sm-3 control-label')) !!}
    <div class="col-sm-6">
        {!! Form::text('street', null, array('class'=>'form-control', 'placeholder'=>'ie. Mama Ngina Street')) !!}
    </div>
</div>
<br>
<br>
<div class="form-group">
    ...
    <div class="col-sm-6">
        {!! Form::text('town', null, array('class'=>'form-control', 'placeholder'=>'ie. Nakuru')) !!}
    </div>
</div>
<br>
<br>
