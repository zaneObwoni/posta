                    ...
                    @if($individuals->count())
                        @foreach($individuals as $individual)
                            <tr>
                                ...
                                <td>{!! $individual->postbox_id !!}-{!! $individual->postcode_id !!}</td>
                                <td>{!! $individual->town !!}</td>   
                            </tr>
                        @endforeach
                    @endif
...
<script type="text/javascript">
    ...
    $(function() {
        ...
        function cb(start, end) {
            ...
            window.location.href = "/admin/reports/individuals/"+start.format('YYYY-MM-DD')+"/"+end.format('YYYY-MM-DD')+"";
        }
