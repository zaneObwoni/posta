                    ...
                    @if($pickings->count())
                        @foreach($pickings as $picking)
                            <tr>
                                ...
                                <td>{!! $picking->town !!}</td>
                                <td>{!! $picking->d_building_name !!}</td>
                                <td>{!! $picking->d_street !!}</td>
                                <td>{!! $picking->d_town !!}</td>
                                <td>{!! $picking->phone !!}</td>
...
<script type="text/javascript">
    ...
    $(function() {
        ...
        function cb(start, end) {
            ...
            window.location.href = "/admin/reports/picking/"+start.format('YYYY-MM-DD')+"/"+end.format('YYYY-MM-DD')+"";
        }
