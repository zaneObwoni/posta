                    ...
                    <div class="row">
                        ...
                        @elseif(strlen($code) < 15)
                            <div class="col-md-12">
                                ...
                                $message = $estamp->message;

                                if($estamp->season == "Examinations"){
                                    $message = 'Dear '. $estamp->recipient_name.', Posta joins '. $estamp->sender_name.' in wishing you success in your Examinations';
                                }else{
                                    $message = $estamp->message;
                                }
                                ...
                                <div style="margin-left:5%; margin-top:5%; text-align:center;">
                                    <h4>
                                        ...
                                        <br>
                                        <b>
                                            Would you like us to pick your Letter/Parcel?
                                            <a href="{!! route('pickings.create', $estamp->code) !!}">Click here</a>
                                        </b>
                                    </h4>
                                </div>
                            </div>
