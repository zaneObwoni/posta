                        ...
                        <div class="col-md-12">
                            ...
                            <div style="margin-left: -3%; padding: 2%; width: 100%;">
                                <div class="row">
                                    ...
                                    <div class="col-lg-9">
                                        <h2>
                                            <div>Underpaid Parcel Scanner</div>
                                        </h2>
                                        <br>
                                        <div>
    ...
    function submitdata()
    {
        ...
        function ajax_search(value){
            ...
            if (amount != null) {
                ...
                display2["postal_code"] = "<?php echo $user->postcode_id?>";
                info = [];
                info[0] = display2;
                ...
                $.ajax({
                    url: '/api/v1/underpayment/parcel/create/' + JSON.stringify(info)
                    // data: info
                })
                        .done(function (msg) {
                            alert('Success Notification sent!'+ msg);
//                            if(msg=='0')
//                            {
